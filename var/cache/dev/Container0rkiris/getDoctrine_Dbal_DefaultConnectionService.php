...
$c->addEventListener(array(0 => 'postLoad'), ${($_ = isset($this->services['AppBundle\Event\ProfileEntitySubscriber']) ? $this->services['AppBundle\Event\ProfileEntitySubscriber'] : $this->load('getProfileEntitySubscriberService.php')) && false ?: '_'});
