...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener(0, array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\Event\ProfileEntitySubscriber']) ? $this->services['AppBundle\Event\ProfileEntitySubscriber'] : $this->load('getProfileEntitySubscriberService.php')) && false ?: '_'};
        }, 1 => 'postLoad'), 0);
