...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\event\\generatefilesubscriber' => 'AppBundle\\Event\\GenerateFileSubscriber',
            'appbundle\\form\\profiletype' => 'AppBundle\\Form\\ProfileType',
            'appbundle\\managers\\filemanager' => 'AppBundle\\Managers\\FileManager',
            'randombundle\\event\\userentitysubscriber' => 'RandomBundle\\Event\\UserEntitySubscriber',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Event\\GenerateFileSubscriber' => 'getGenerateFileSubscriberService.php',
            'AppBundle\\Form\\ProfileType' => 'getProfileTypeService.php',
            'AppBundle\\Managers\\FileManager' => 'getFileManagerService.php',
            'RandomBundle\\Event\\UserEntitySubscriber' => 'getUserEntitySubscriberService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Event\\GenerateFileSubscriber' => true,
            'AppBundle\\Form\\ProfileType' => true,
            'AppBundle\\Managers\\FileManager' => true,
            'RandomBundle\\Event\\UserEntitySubscriber' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('BLG7+9XiFL', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SShoMiCCbK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P9wPnCxeRJ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Borj9uieQU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('form.pre_set_data', array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\Event\GenerateFileSubscriber']) ? $this->services['AppBundle\Event\GenerateFileSubscriber'] : $this->load('getGenerateFileSubscriberService.php')) && false ?: '_'};
        }, 1 => 'onPreSetData'), 0);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/RandomBundle/Resources/views'), 'Random');
        $instance->addPath(($this->targetDirs[3].'/src/RandomBundle/Resources/views'), '!Random');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'RandomBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/RandomBundle'),
                    'namespace' => 'RandomBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            case 'uploads': $value = ($this->targetDirs[3].'/web/public/uploads'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RandomBundle' => 'RandomBundle\\RandomBundle',
