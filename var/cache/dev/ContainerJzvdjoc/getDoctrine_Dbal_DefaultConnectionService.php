...
$c->addEventListener(array(0 => 'postLoad'), ${($_ = isset($this->services['AppBundle\Event\ProfileEntitySubscriber']) ? $this->services['AppBundle\Event\ProfileEntitySubscriber'] : $this->services['AppBundle\Event\ProfileEntitySubscriber'] = new \AppBundle\Event\ProfileEntitySubscriber($this)) && false ?: '_'});
$c->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['doctrine.orm.default_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.default_listeners.attach_entity_listeners'] : $this->services['doctrine.orm.default_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener()) && false ?: '_'});

return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlite', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'path' => ($this->targetDirs[2].'/data/data.sqlite'), 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
