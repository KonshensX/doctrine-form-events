...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\event\\profileentitysubscriber' => 'AppBundle\\Event\\ProfileEntitySubscriber',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Event\\ProfileEntitySubscriber' => 'getProfileEntitySubscriberService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Event\\ProfileEntitySubscriber' => true,
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener(0, array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\Event\ProfileEntitySubscriber']) ? $this->services['AppBundle\Event\ProfileEntitySubscriber'] : $this->services['AppBundle\Event\ProfileEntitySubscriber'] = new \AppBundle\Event\ProfileEntitySubscriber($this)) && false ?: '_'};
        }, 1 => 'postLoad'), 0);
        $instance->addListener(1, array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\Event\ProfileEntitySubscriber']) ? $this->services['AppBundle\Event\ProfileEntitySubscriber'] : $this->services['AppBundle\Event\ProfileEntitySubscriber'] = new \AppBundle\Event\ProfileEntitySubscriber($this)) && false ?: '_'};
        }, 1 => 'preUpdate'), 0);
        $instance->addListener(2, array(0 => function () {
            return ${($_ = isset($this->services['AppBundle\Event\ProfileEntitySubscriber']) ? $this->services['AppBundle\Event\ProfileEntitySubscriber'] : $this->services['AppBundle\Event\ProfileEntitySubscriber'] = new \AppBundle\Event\ProfileEntitySubscriber($this)) && false ?: '_'};
        }, 1 => 'prePersist'), 0);
